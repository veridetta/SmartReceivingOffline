...
public final class ActivityScanBinding implements ViewBinding {
  ...
  private ActivityScanBinding(@NonNull FrameLayout rootView, @NonNull CodeScannerView scannerView) {
  ...
  public static ActivityScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityScanBinding((FrameLayout) rootView, scannerView);
    }
